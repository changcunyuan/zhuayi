...
$MEMCACHE_SERVERS[] = '10.52.156.11:8211'; // add more as an array
$MEMCACHE_SERVERS[] = '10.52.175.39:8211'; // add more as an array
...
EOB;
        foreach($MEMCACHE_SERVERS as $server){
            ...
            echo '<tr class=tr-1><td class=td-1>'.$server.'</td><td><a href="'.$PHP_SELF.'&server='.array_search($server,$MEMCACHE_SERVERS).'&op=6">[<b>刷新</b>]</a></td></tr>';
    		...
    		echo '<tr class=tr-1><td class=td-0>使用的缓存大小</td><td>',bsize($memcacheStatsSingle[$server]['STAT']['bytes']),'</td></tr>';
    ...
    echo <<<EOB
		...
		<div class="graph div3"><h2>主机状态图</h2>
		<table cellspacing=0><tbody>
EOB;
